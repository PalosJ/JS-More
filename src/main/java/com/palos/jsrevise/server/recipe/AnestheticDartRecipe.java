...
public final class AnestheticDartRecipe extends ShapedRecipe {
        ...
        super(
                ...
                ShapedRecipePattern.of(
                        Map.of(
                                ...
                                'S', Ingredient.of(JSReviseItems.ANESTHETIC_SYRINGE.get())
                        ),
                        " F",
                        "S "
                ),
    ...
    public boolean matches(CraftingInput input, Level level) {
        ...
        for (int y = 0; y < input.height(); y++) {
            for (int x = 0; x < input.width(); x++) {
                ...
                if (stack.is(JSReviseItems.ANESTHETIC_SYRINGE.get()) && syringeX < 0) {
                    syringeX = x;
                    syringeY = y;
    ...
    public RecipeSerializer<?> getSerializer() {
        return JSReviseRecipeSerializers.ANESTHETIC_DART.get();
    }
}
