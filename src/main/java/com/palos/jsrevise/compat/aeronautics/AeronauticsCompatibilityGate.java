...
public final class AeronauticsCompatibilityGate {
    public static final String AERONAUTICS_BUNDLE_PROPERTY = "jsrevise.test.aeronautics.bundle.jar";
    public static final String SABLE_JAR_PROPERTY = "jsrevise.test.sable.jar";
    public static final String CREATE_JAR_PROPERTY = "jsrevise.test.create.jar";
    public static final String DIESEL_GENERATORS_JAR_PROPERTY =
            "jsrevise.test.aeronautics.diesel-generators.jar";
    public static final String ENCHANTMENT_INDUSTRY_JAR_PROPERTY =
            "jsrevise.test.aeronautics.enchantment-industry.jar";
    public static final String DRAGONS_PLUS_JAR_PROPERTY =
            "jsrevise.test.aeronautics.dragons-plus.jar";
