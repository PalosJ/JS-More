...
public final class JSAnimalProfileGameTests {
    ...
    public static void zeroDurabilityCapturedStackReleasesAnimalAndCreatesBrokenCarrier(GameTestHelper helper) {
        ...
        if (result != DinosaurCaptureService.StackSettlementResult.BROKEN
                ...
                || !replacement.is(JSMoreItems.BROKEN_DINOSAUR_CAPTURE_BOX.get())
        ...
        for (JSAnimal<?> registeredAnimal : JSAnimals.getAnimals()) {
            ...
            try {
                ...
                if (animal instanceof JSAquaticBase aquatic) {
                    ...
                    aquatic.getData(JSMoreAttachments.ANESTHETIC).clear();
                    if (aquatic.isPushedByFluid()) {
    ...
    public static void anesthetizedAnimalsExposeSleepBeforeServerAnimation(GameTestHelper helper) {
        ...
        for (JSAnimal<?> registeredAnimal : JSAnimals.getAnimals()) {
            ...
            try {
                ...
                AnestheticData anestheticData = animal.getData(JSMoreAttachments.ANESTHETIC);
    ...
    public static void sleepAnimationGuardBlocksOrdinaryAnimationDefinitions(GameTestHelper helper) {
        ...
        for (JSAnimal<?> registeredAnimal : JSAnimals.getAnimals()) {
            ...
            try {
                ...
                AnestheticData readyData = animal.getData(JSMoreAttachments.ANESTHETIC);
