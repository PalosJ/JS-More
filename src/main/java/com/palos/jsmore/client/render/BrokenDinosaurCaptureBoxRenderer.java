...
public final class BrokenDinosaurCaptureBoxRenderer implements BlockEntityRenderer<BrokenDinosaurCaptureBoxBlockEntity> {
    static final ResourceLocation FRONT_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_front.png");
    static final ResourceLocation BACK_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_back.png");
    static final ResourceLocation SIDE_BADGE_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_side_badge.png");
    static final ResourceLocation SIDE_BARS_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_side_bars.png");
    static final ResourceLocation TOP_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_top.png");
    static final ResourceLocation BOTTOM_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_bottom.png");
    static final ResourceLocation DEBRIS_TEXTURE = JSMore.id("textures/block/broken_dinosaur_capture_box_debris_sheet.png");
