...
public final class AeronauticsProfileGameTests {
    public static final String EXPECTED_STATUS_PROPERTY = "jsmore.test.aeronautics.expected-status";
    private static final String LINKED_TEST_BRIDGE =
            "com.palos.jsmore.compat.aeronautics.linked.ExactAeronauticsGameTestBridge";
