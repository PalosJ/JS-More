...
public final class CaptureBoxDropProjectionHandler {
    ...
    public static void onEntityJoinLevel(EntityJoinLevelEvent event) {
        ...
        try {
            ...
            // Projection must see the original plot-local coordinates. Recovery protection may relocate an unsafe
            // carrier, so apply it only after the plot-to-parent projection attempt has finished.
            RecoveryCarrierService.onEntityJoin(item, level);
        }
    }
